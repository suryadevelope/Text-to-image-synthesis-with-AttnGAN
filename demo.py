...
def demo_gan():
    ...
    st.subheader("Enter the description of the image to be generated in the text box you like !!!")
    st.write(
        "**Example**: A yellow bird with red crown, black short beak and long tail"
    )
    st.markdown("**PS**: The synthesized images might not even exist on earth 😬 😮 😱")
    st.markdown("#")

    user_input = st.text_input("Write the description below")
    st.markdown("---")
